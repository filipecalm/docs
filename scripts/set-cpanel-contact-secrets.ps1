param(
  ...
  [string]$SmtpPassword,
  [string]$SmtpHost = "mail.dietos.com.br",
  [string]$SmtpPort = "465",
...
Write-Host ""
Write-Host "Secrets SMTP (cPanel) atualizados: $SmtpUser @ ${SmtpHost}:$SmtpPort"
Write-Host "Confirma o host em cPanel -> Email Accounts -> Connect Devices se falhar."
